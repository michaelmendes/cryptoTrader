...
public class CryptoCoin {
	...
	public void setCoinPrice(double price) {
		coinPrice = price;
	}
	...
	private String convertInput(String cName){
		String[][] conversions = {
				...
				{"DASH", "Dash"},{"NEXO", "Nexo"},{"BAT", "Basic Attention Token"},{"HEART", "Humans.ai"},{"AMP", "Amp"},{"FXS", "Frax Share"},{"JUNO", "JUNO"},{"MINA", "Mina Protocol"},{"BIT", "BitDAO"}, {"HOT", "Holo"}
